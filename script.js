...
// API configuration
const API_KEY = "AIzaSyCfjBj_e9eqpJRSI0l-et5xtKNMYlIfYPo"; // Your API key here
...
const showLoadingAnimation = () => {
  const html = `<div class="message-content">
                  <img class="avatar" src="/image copy.png" alt="Gemini avatar">
                  <p class="text"></p>
...
// Theme toggle and painting animation
...
themeToggleButton.addEventListener("click", () => {
  // Trigger the painting animation
  themeTransition.classList.add("active");

  // Wait for the animation to finish before toggling theme
  setTimeout(() => {
  ...
  }, 400); // Half the animation duration for a seamless effect
});
